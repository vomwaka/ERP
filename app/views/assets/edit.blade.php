	...
	<div class="col-lg-12" style="background: #E1F5FE">
		<form class="form-inline" role="form" action="" method="POST">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control input-sm" name="warrantyExpiry" placeholder="Warranty Expiry">
			</div>&emsp;
			...
			<div class="form-group">
				...
				<select class="form-control input-sm" name="assetType" style="width: 300px" required>
