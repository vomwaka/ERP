...
<div class="row">
	<div class="col-lg-5">
        ...
        @endif
		 ...
		 <form method="POST" action="{{{ URL::to('css/advances') }}}" accept-charset="UTF-8">
    ...
    <fieldset>
        <div class="form-group">
                        ...
                        <input class="form-control datepicker60" readonly="readonly" placeholder="" type="text" name="date" id="date" value="{{{ Input::old('date') }}}">
                        </div>
        </div>
        ...
        <div class="form-group">
           ...
           <select name="type" class="form-control">
                           <option></option>
                            <option value="Full paycheque"> Full paycheque</option>
