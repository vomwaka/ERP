...
<div class="row">
  ...
  <a  href="{{ URL::to('memberloan/offprint/'.$loanaccount->id)}}" target="_blank" > <span class="glyphicon glyphicon-file" aria-hidden="true"></span> Print Report</a>
	...
	<div class="col-lg-5">
       ...
       <table class="table table-condensed table-bordered">
        ...
        <tr>
		 ...
		 <form method="POST" action="{{{ URL::to('memberloanrepayments/offsetloan') }}}" accept-charset="UTF-8">
    ...
    <fieldset>
       ...
       <table class="table table-condensed table-bordered">
        ...
        <div class="form-group">
            ...
            <input class="form-control" placeholder="" readonly type="date" name="date" id="date" value="{{date('Y-m-d')}}">
        </div>
