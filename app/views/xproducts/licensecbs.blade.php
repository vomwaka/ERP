...
<div class="row">
	<div class="col-lg-5">
        ...
        @endif
		 ...
		 <form onsubmit="return Validate(this);" method="POST" action="{{ URL::to('requestcbslicensekey')}}" id="requestform" accept-charset="UTF-8">
...
<?php }else if(file_exists(public_path().'/uploads/license txts/cbs/'.Organization::binToStr($part[0]).' cbs license '.str_replace("-", "", Organization::binToStr($part[4])).'.license')){?>
...
<form method="POST" action="{{ URL::to('activatedproducts/updatelicense/CBS')}}" id="requestform" accept-charset="UTF-8"> 
...
<input class="form-control" placeholder="" type="hidden" name="cperiod" id="cperiod" value="{{Organization::binToStr($part[4])}}">
